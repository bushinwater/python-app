...
if file_path:
    ...
    label_cena.grid(row=1, column=0, padx=10, pady=5, sticky=tk.E)
    entery2.grid(row=1, column=1, padx=10, pady=5, sticky=tk.W)


    entery1.bind("<Return>", focus_next_widget)
    entery2.bind("<Return>", activate_button)  # Activate 'Pronadji artikl' button
    ...
    dugme.grid(row=2, column=0, columnspan=2, pady=10)
